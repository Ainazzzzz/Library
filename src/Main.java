...
public class Main {
    public static void main(String[] args) {
        ...
        Client[] clients = {
                new Client("Анна Смирнова", 100.0, 25),
                new Client("Иван Иванов", 50.0, 30),
                new Client("Елена Кузнецова", 75.0, 22),
                new Client("Олег Васильев", 40.0, 35),
                new Client("Мария Петрова", 90.0, 28),
                new Client("Алексей Сидоров", 60.0, 45),
                new Client("Светлана Орлова", 80.0, 33),
                new Client("Дмитрий Кузьмин", 70.0, 40),
                new Client("Ольга Зайцева", 110.0, 26),
                new Client("Павел Морозов", 30.0, 50)
        };
